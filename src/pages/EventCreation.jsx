...
export default function EventCreation() {
  ...
  // React.useEffect(() => {
  //   listAll(ref(image, "images/")).then((imgs) => {
  //       console.log(imgs);
  //   });
  // }, []);
  ...
  async function handleSubmitButton() {
    ...
    let bodyContent = JSON.stringify({
      organizerId: "to-be-fixed-when-we-have-auth-running",
      title: eventData.eventName,
      description: eventData.eventDescription,
      ticketPrice: Number(eventData.ticketPrice), // eventData.ticketPrice,
      capacity: Number(eventData.capacity), // eventData.capacity,
      availableTickets: Number(eventData.capacity), // eventData.capacity,
    ...
    <div>
      ...
      <div className="event-creation-container">
        <div
          ...
          style={{ backgroundImage: imageUrlLocal ? `url(${imageUrlLocal})` : "none" }}
        >
