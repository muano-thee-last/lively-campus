...
describe('Notifications Component', () => {
  ...
  it('renders notifications after loading', async () => {
    const mockNotifications = [
      { id: '1', eventId: 'event1', message: 'Test notification 1', timestamp: { _seconds: Date.now() / 1000 } },
    ];
  ...
  it('displays "Today" for current date notifications', async () => {
    ...
    const mockNotifications = [
      { id: '1', eventId: 'event1', message: 'Today\'s notification', timestamp: { _seconds: today.getTime() / 1000 } },
    ];
